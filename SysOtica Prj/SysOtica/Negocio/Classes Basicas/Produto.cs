...
namespace SysOtica.Negocio.Classes_Basicas
{
    public class Produto
    {
        ...
        public Produto(int pr_id, string pr_descricao, string pr_unidade, string pr_grupo, string pr_grife, double pr_valor, int pr_qtd, int pr_estoqueminimo, List<ProdutoFornecedor> pf_id, List<ProdutoVenda> pv_id, List<Categoria> ct_id)
        {
            this.Pr_id = pr_id;
